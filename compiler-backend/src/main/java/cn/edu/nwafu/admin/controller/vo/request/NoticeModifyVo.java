...
public class NoticeModifyVo
{
    ...
    public static Problem convertToNotice(NoticeModifyVo noticeAddVo)
    {
        Problem problem = new Problem();
        BeanUtils.copyProperties(noticeAddVo, problem);
        problem.setVisibility(NoticeVisibilityEnum.ofCode(noticeAddVo.getVisibility()));
        return problem;
    }
